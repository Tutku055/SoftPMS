...
public static class DatabaseSeeder
{
    ...
    private const string AdminEmail     = "admin@softlarepms.com";
    ...
    public static async Task SeedAsync(IServiceProvider rootProvider, CancellationToken ct = default)
    {
        ...
        var db     = sp.GetRequiredService<SoftlarePMSDbContext>();
        var logger = sp.GetRequiredService<ILogger<SoftlarePMSDbContext>>();
