...
{
    [DbContext(typeof(SoftlarePMSDbContext))]
    [Migration("20260719101901_AddDepartmentAndRemoveAddressDates")]
    partial class AddDepartmentAndRemoveAddressDates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoftlarePMS.Domain.Entities.AuditLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SoftlarePMS.Domain.Entities.EmployeeCompensation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SoftlarePMS.Domain.Entities.EmployeeDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SoftlarePMS.Domain.Entities.EmployeeNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SoftlarePMS.Domain.Entities.EmployeeReference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SoftlarePMS.Domain.Entities.Permission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SoftlarePMS.Domain.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SoftlarePMS.Domain.Entities.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("SoftlarePMS.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SoftlarePMS.Domain.Entities.UserRole", b =>
                {
            ...
            modelBuilder.Entity("SoftlarePMS.Domain.Entities.Employee", b =>
                {
                    b.HasOne("SoftlarePMS.Domain.Entities.User", "CreatedByUser")
            ...
            modelBuilder.Entity("SoftlarePMS.Domain.Entities.EmployeeAddress", b =>
                {
                    b.HasOne("SoftlarePMS.Domain.Entities.Employee", "Employee")
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("SoftlarePMS.Domain.Entities.RolePermission", b =>
                {
                    b.HasOne("SoftlarePMS.Domain.Entities.Permission", "Permission")
                        .WithMany("RolePermissions")
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SoftlarePMS.Domain.Entities.Role", "Role")
                        .WithMany("RolePermissions")
            ...
            modelBuilder.Entity("SoftlarePMS.Domain.Entities.User", b =>
                {
                    b.HasOne("SoftlarePMS.Domain.Entities.Employee", "Employee")
                        .WithOne("LinkedUser")
                        .HasForeignKey("SoftlarePMS.Domain.Entities.User", "EmployeeId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("SoftlarePMS.Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasOne("SoftlarePMS.Domain.Entities.User", "User")
                        .WithMany("UserRoles")
